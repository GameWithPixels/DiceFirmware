...
#define UCUNIT_WritePassedMsg(msg, args)                        \
    ...
    {                                                           \
        NRF_LOG_INFO("------------------------------------");   \
        NRF_LOG_INFO("%s:%d: Passed!", __FILE__, __LINE__);     \
        NRF_LOG_INFO("%s (%s)", msg, args);                     \
        NRF_LOG_INFO("------------------------------------\n"); \
    } while(0)
#else
#define UCUNIT_WritePassedMsg(msg, args)
...
#define UCUNIT_WriteFailedMsg(msg, args)                        \
    ...
    {                                                           \
        NRF_LOG_INFO("------------------------------------");   \
        NRF_LOG_INFO("%s:%d: Failed!", __FILE__, __LINE__);     \
        NRF_LOG_INFO("%s (%s)", msg, args);                     \
        NRF_LOG_INFO("------------------------------------\n"); \
    } while(0)
#endif
...
{                                                                   \
    NRF_LOG_INFO("**************************************");         \
    NRF_LOG_INFO("Testcases: failed: %d", ucunit_testcases_failed); \
    NRF_LOG_INFO("           passed: %d", ucunit_testcases_passed); \
    NRF_LOG_INFO("Checks:    failed: %d", ucunit_checks_failed);    \
    NRF_LOG_INFO("           passed: %d", ucunit_checks_passed);    \
    NRF_LOG_INFO("**************************************\n"); \
}
