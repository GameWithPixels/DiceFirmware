...
namespace Profile
{
	...
	uint8_t* Data::createDefaultProfile(uint32_t* outSize) {
        ...
        animationRainbow->animFlags = AnimationFlags_Traveling;
        ...
        animationCharging->animFlags = AnimationFlags_None;
        ...
        animationLowBattery->animFlags = AnimationFlags_None;
        ...
        animationChargingProblem->animFlags = AnimationFlags_None;
        ...
        animationFullyCharged->animFlags = AnimationFlags_None;
        ...
        animationConnection->animFlags = AnimationFlags_None;
        ...
        animationRolling->animFlags = AnimationFlags_None;
        ...
        animationOnFace->animFlags = AnimationFlags_None;
        ...
        animationTempError->animFlags = AnimationFlags_None;
