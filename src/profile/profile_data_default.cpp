...
namespace Profile
{
    ...
    uint8_t defaultBytes[] = {
        ...
        0x0D,0xF0,0x0D,0x60,0x03,0x01,0x0F,0x03,0x02,0x00,0x00,0x00,0x02,0x08,0x00,0x00,
        0x02,0x00,0x08,0x00,0x02,0x00,0x00,0x10,0x02,0x06,0x06,0x00,0x02,0x03,0xB8,0x0B,
        0xFF,0xFF,0xFF,0xFF,0x20,0x03,0x80,0x00,0x01,0x04,0xB8,0x0B,0xFF,0xFF,0xFF,0xFF,
        ...
        0x01,0x07,0x20,0xDC,0x05,0x01,0xFE,0x01,0x94,0x00,0x00,0x00,0x00,0x61,0x01,0x1D,
        0xC6,0xDA,0x3B,0x6B,
    };
    ...
    public:
        ...
        Pointer<DGradientRainbow> addRainbow() {
            auto rainbowPtr = allocatePtr<DGradientRainbow>();
            auto rainbow = get(rainbowPtr);
            rainbow->type = GradientType_Rainbow;
            return rainbowPtr;
        }
