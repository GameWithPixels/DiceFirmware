...
namespace Modules::AnimController
{
	...
	void printAnimControllerState(const Message *msg);
	...
	void init()
	{
		...
		MessageService::RegisterMessageHandler(Message::MessageType_PrintAnimControllerState, printAnimControllerState);
