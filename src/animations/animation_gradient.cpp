...
namespace Animations
{
    ...
    /// </summary>
    void AnimationInstanceGradient::start(int _startTime, uint8_t _remapFace, uint8_t _loopCount) {
    ...
    int AnimationInstanceGradient::update(int ms, int retIndices[], uint32_t retColors[]) {
